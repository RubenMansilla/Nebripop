            ...
            <div className='sidebar-left-mobile' ref={sidebarRef} style={{ overflowY: 'auto', height: '100%' }}>
                ...
                <div className="sidebar-menu-mobile">
                    <div className="menu-container">
                        <p className="menu-category">CATÁLOGO</p>
                        <div className={`menu-item-mobile ${location.pathname.startsWith("/catalog") ? "active" : ""}`} onClick={() => navigate("/catalog/published")}>
                    ...
                    <div className="menu-container">
                        <p className="menu-category">TRANSACCIONES</p>
                        <div className={`menu-item-mobile ${location.pathname.startsWith("/purchases") ? "active" : ""}`} onClick={() => navigate("/purchases/ongoing")}>
                        ...
                        <div className={`menu-item-mobile ${location.pathname.startsWith("/sales") ? "active" : ""}`} onClick={() => navigate("/sales/ongoing")}>
                        ...
                        <div className={`menu-item-mobile ${location.pathname.startsWith("/wallet") ? "active" : ""}`} onClick={() => navigate("/wallet/balance")}>
                    ...
                    <div className="menu-container">
                        <p className="menu-category">COMUNICACIÓN</p>
                        <div className={`menu-item-mobile ${location.pathname.startsWith("/profile/chat") ? "active" : ""}`} onClick={() => navigate("/profile/chat")}>
                    ...
                    <div className="menu-container">
                        <p className="menu-category">CUENTA</p>
                        <div className={`menu-item-mobile ${location.pathname.startsWith("/favorites") ? "active" : ""}`} onClick={() => navigate("/favorites/products")}>
                        ...
                        <div
                            className={`menu-item-mobile ${location.pathname === "/profile/stats" ? "active" : ""}`}
                        ...
                        <div className={`menu-item-mobile ${location.pathname.startsWith("/settings") ? "active" : ""}`} onClick={() => navigate("/settings")}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="menu-container">
                        <p className="menu-category">SOPORTE</p>
                        <div className={`menu-item-mobile ${location.pathname.startsWith("/help") ? "active" : ""}`} onClick={() => navigate("/help")}>
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
