        ...
        <>
            <div className='sidebar-left' ref={sidebarRef} style={{ overflowY: 'auto', height: '100%' }}>
                ...
                <div className="sidebar-menu">
                    <div className={`menu-item ${location.pathname.startsWith("/purchases") ? "active" : ""}`} onClick={() => navigate("/purchases/ongoing")}>
                    ...
                    <div className={`menu-item ${location.pathname.startsWith("/sales") ? "active" : ""}`} onClick={() => navigate("/sales/ongoing")}>
                    ...
                    <div className={`menu-item ${location.pathname.startsWith("/catalog") ? "active" : ""}`} onClick={() => navigate("/catalog/published")}>
                    ...
                    <div className={`menu-item ${location.pathname.startsWith("/my-auctions") ? "active" : ""}`} onClick={() => navigate("/my-auctions/created")}>
                    ...
                    <div className={`menu-item ${location.pathname.startsWith("/wallet") ? "active" : ""}`} onClick={() => navigate("/wallet/balance")}>
                    ...
                    <div className={`menu-item ${location.pathname.startsWith("/settings") ? "active" : ""}`} onClick={() => navigate("/settings")}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={`menu-item ${location.pathname.startsWith("/help") ? "active" : ""}`} onClick={() => navigate("/help")}>
                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
